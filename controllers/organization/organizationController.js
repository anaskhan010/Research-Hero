...
// =====================Create Orginxation Details Controller =======================

// create Organization Contoller
var createOrganizationDetails = async function (req, res) {
  var { organization_name, organization_address } = req.body;
  try {
    var result = await organizationModel.createOrganization(
      organization_name,
