      ...
      db.query(
        ...
        function (userErr, userResult) {
          ...
          var organizationQuery =
            "INSERT INTO organization (user_id, first_name, last_name, status, gender, address, contact_number, date_of_birth, stipend, study_enrolled, notification,organization_detail_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
          db.query(
            organizationQuery,
            [
              userId,
...
var getAllOrganizations = function () {
  return new Promise(function (resolve, reject) {
    var query = `
    SELECT o.*, u.email,org.organization_name , org.organization_address, MAX(n.note) AS note
...
// create organization model for organization detail
const createOrganizationDetail = (organization_name, organization_address) => {
  return new Promise((resolve, reject) => {
    db.query(
      `INSERT INTO organization_details (organization_name, organization_address) VALUES (?, ?)`,
...
// get all organization detail model
const getAllOrganizationDetails = () => {
  return new Promise((resolve, reject) => {
    const query = `SELECT * FROM organization_details`;
...
module.exports = {
  ...
  // Organization Detail Model
  createOrganizationDetail: createOrganizationDetail,
  getAllOrganizationDetails: getAllOrganizationDetails,
};
